    ...
    <div class="lot-item__content">
        <div class="lot-item__left">
            ...
            <p class="lot-item__category">Категория:
                <span><?= htmlspecialchars($lot['category'] ?? 'Без категории') ?></span></p>
        ...
        ">
                ...
                <div class="lot-item__cost-state">
                    <div class="lot-item__rate">
                        ...
                        <span
                            class="lot-item__cost"><?= htmlspecialchars(format_price($lot['current_price'] / 100 ?? 0)) ?></span>
                    </div>
                    <div class="lot-item__min-cost">
                        Мин. ставка <span><?= htmlspecialchars(format_price($lot['min_bid'] / 100 ?? 0)) ?></span>
                    </div>
                </div>
                <?php if ($show_bids): ?>
                    <form class="lot-item__form" action="<?= $_SERVER['REQUEST_URI'] ?>" method="post"
                        ...
                        <p class="lot-item__form-item form__item <?= !empty($errors) ? "form__item--invalid" : "" ?>">
                            ...
                            <input id="cost" type="text" name="cost"
                                   placeholder="<?= htmlspecialchars($lot['min_bid'] / 100 ?? "Минимальная ставка отсуствует") ?>">
                ...
                <table class="history__list">
                    <?php foreach ($bids as $bid): ?>
                        <tr class="history__item">
                            ...
                            <td class="history__price"><?= htmlspecialchars(format_price($bid['bid_price'] / 100)) ?></td>
