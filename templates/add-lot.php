<form enctype="multipart/form-data" class="form form--add-lot container <?php if (!empty($errors)): ?>
form--invalid
<?php endif; ?>
" action="add.php" method="post"> <!-- form--invalid -->
            ...
            <select id="category" name="category">
                ...
                <?php foreach ($categories as $category): ?>
                    <option value="<?= htmlspecialchars($category['category_id']) ?>"
                        ...
                        <?php endif; ?>
                    >
                        <?= htmlspecialchars($category['name'] ?? 'Invalid Category') ?>
                    </option>
                <?php endforeach; ?>
            </select>
